...
const routeOnCancel = useFormRedirectOnCancel(
  isEditing.value
    ? { name: 'key-detail', params: { workspace: workspace.value, id: id.value } }
    : { name: 'key-list', params: { workspace: workspace.value } },
)
...
const handleUpdate = (entity) => {
  router.push(routeOnUpdate || { name: 'key-detail', params: { workspace: workspace.value, id: entity.id ?? '' } })
  toaster.open({
    appearance: 'success',
