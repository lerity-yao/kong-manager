...
const routeOnCancel = useFormRedirectOnCancel({ name: 'sni-list', params: { workspace: workspace.value } })

const routeOnUpdate = useFormRedirectOnUpdate({ name: 'sni-list', params: { workspace: workspace.value } })
