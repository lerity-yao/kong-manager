...
const routeOnCancel = useFormRedirectOnCancel(
  isEditing.value
    ? { name: 'upstream-detail', params: { workspace: workspace.value, id: id.value } }
    : { name: 'upstream-list', params: { workspace: workspace.value } },
)
...
const handleUpdate = (entity) => {
  router.push({ name: 'upstream-detail', params: { workspace: workspace.value, id: entity.id || id.value } })
  toaster.open({
    appearance: 'success',
    message: t(
